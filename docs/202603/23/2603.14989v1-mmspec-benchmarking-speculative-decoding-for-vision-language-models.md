...
method: 提出了首个VLM投机采样基准MMSpec，并开发了能根据视觉Token动态调整投机策略的ViSkip方法。
result: 实验揭示了纯文本投机算法在多模态任务中的局限性，并证明了视觉感知在大批量推理中的重要性。
conclusion: ViSkip作为一种即插即用的方法，在多模态任务中显著提升了推理效率，达到了当前领先水平。
---
